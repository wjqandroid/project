//package com.visionvera.live.player;
//
...
//import com.visionvera.live.player.bean.TCPlayInfoStream;
//import com.visionvera.live.player.common.TCPlayerConstants;
//import com.visionvera.live.player.controller.TCVodControllerBase;
//import com.visionvera.live.player.controller.TCVodControllerFloat;
//import com.visionvera.live.player.controller.TCVodControllerLarge;
//import com.visionvera.live.player.controller.TCVodControllerSmall;
//import com.visionvera.live.player.net.LogReport;
//import com.visionvera.live.player.utils.NetWatcher;
//import com.visionvera.live.player.utils.SuperPlayerUtil;
//import com.visionvera.live.player.v3.SuperPlayerModelWrapper;
//import com.visionvera.live.player.v3.SuperPlayerVideoId;
//import com.visionvera.live.player.v3.SuperVodInfoLoaderV3;
//import com.visionvera.live.player.view.TCDanmuView;
...
//            }
//        } else {
//            //刘传政:这个resume原来是注释掉的.但是会导致直播不能暂停.这里修改源码解开注释
//            if (mLivePlayer != null) {
//                mLivePlayer.resume();
//                //以下主要是设置直播控制器的屏幕适配模式为自适应,否则他不知道为什么改成了铺满屏幕,导致
//                //有的画面被裁剪了.
//                SuperPlayerGlobalConfig config = SuperPlayerGlobalConfig.getInstance();
//                config.renderMode = TXLiveConstants.RENDER_MODE_ADJUST_RESOLUTION;
//                mLivePlayConfig = new TXLivePlayConfig();
...
//            if (mPlayerViewCallback != null) {
//                mPlayerViewCallback.onShareSmall();
//            }
//        }
//
//        /**
...
//            if (mPlayerViewCallback != null) {
//                mPlayerViewCallback.onShareLarge();
//            }
//        }
//
//        /**
...
//            if (mPlayerViewCallback != null) {
//                mPlayerViewCallback.onCollectSmall();
//            }
//        }
//
//        /**
...
//            if (mPlayerViewCallback != null) {
//                mPlayerViewCallback.onCollectLarge();
//            }
//        }
//
//    };
...
//                    Toast.makeText(mContext, "连接失败,点击重试", Toast.LENGTH_SHORT).show();
//                } else {
//                    Toast.makeText(mContext, param.getString(TXLiveConstants.EVT_DESCRIPTION), Toast.LENGTH_SHORT).show();
//                }
//            }
...
//            if (mPlayerViewCallback != null) {
//                mPlayerViewCallback.onLinkError();
//            }
//        }
////        if (event < 0) {
////            mVodControllerSmall.updateReplay(false);
...
//        if (mVodControllerSmall != null) {
//            mVodControllerSmall.updateCollect(collect);
//        }
//        if (mVodControllerLarge != null) {
//            mVodControllerLarge.updateCollect(collect);
//        }
//    }
//}
