//package com.visionvera.live.player.controller;
//
...
//import com.visionvera.live.player.bean.TCPlayImageSpriteInfo;
//import com.visionvera.live.player.bean.TCPlayKeyFrameDescInfo;
//import com.visionvera.live.player.common.TCPlayerConstants;
//import com.visionvera.live.player.net.LogReport;
//import com.visionvera.live.player.utils.TCTimeUtils;
//import com.visionvera.live.player.view.TCPointSeekBar;
//import com.visionvera.live.player.view.TCVideoProgressLayout;
//import com.visionvera.live.player.view.TCVideoQulity;
//import com.visionvera.live.player.view.TCVodMoreView;
//import com.visionvera.live.player.view.TCVodQualityView;
//import com.visionvera.live.player.view.TCVolumeBrightnessProgressLayout;
//
...
//
//    private ImageView ivCollectLarge;
//    private ImageView ivShareLarge;
...
//
//        ivCollectLarge = (ImageView) findViewById(R.id.iv_collect_large);
//        ivShareLarge = (ImageView) findViewById(R.id.iv_share_large);
//        tvOnlinePeople = (TextView) findViewById(R.id.tv_onlinePeople_large);
//
...
//
//        ivCollectLarge.setOnClickListener(this);
//        ivShareLarge.setOnClickListener(this);
...
//        mTvVttText.setOnClickListener(new View.OnClickListener() {
//            @Override
...
//            backToLive();
//        } else if (i == R.id.iv_share_large) {
//            onShareLarge();
//        } else if (i == R.id.iv_collect_large) {
//            onCollectLarge();
//        }
//    }
//
...
//     * 分享按钮
//     */
//    private void onShareLarge() {
//        mVodController.onShareLarge();
//    }
//
//    /**
//     * 返回直播
...
//     * 收藏按钮
//     */
//    private void onCollectLarge(){
//        mVodController.onCollectLarge();
//    }
//
//    /**
//     * 改变锁屏状态
...
//
//    /**
//     * 更新收藏按钮状态true 收藏 false 未收藏
//     */
//    public void updateCollect(boolean collect){
//        if (collect){
//            ivCollectLarge.setImageResource(R.drawable.ic_had_collect);
//        }else{
//            ivCollectLarge.setImageResource(R.drawable.ic_collect);
//        }
//    }
//}
