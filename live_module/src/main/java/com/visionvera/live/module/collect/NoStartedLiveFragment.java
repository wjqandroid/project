...
import com.visionvera.live.module.collect.adapter.NoStartedLiveAdapter;
 ...
 */
public class NoStartedLiveFragment extends BaseFragment implements CollectContract.ICollectList.IView {
    ...
    private NoStartedLiveAdapter mAdapter;
    private CollectListPresenter mPresenter;

    public static NoStartedLiveFragment newInstance() {
        return new NoStartedLiveFragment();
    }
    ...
    private void initAdapter() {
        ...
        mAdapter = new NoStartedLiveAdapter(act);
    ...
    private void requestLiveList() {
        ...
        map.put(HttpInterface.ParamKeys.PLAY_MODEL, "4");
