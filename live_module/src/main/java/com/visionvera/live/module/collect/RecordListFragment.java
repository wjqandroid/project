...
import com.visionvera.live.module.collect.adapter.RecordListAdapter;
 ...
 */
public class RecordListFragment extends BaseFragment implements CollectContract.ICollectList.IView {
    ...
    private void initAdapter() {
        ...
        mAdapter = new RecordListAdapter(act);
    ...
    private void requestLiveList() {
        ...
        map.put(HttpInterface.ParamKeys.PLAY_MODEL, "1");
