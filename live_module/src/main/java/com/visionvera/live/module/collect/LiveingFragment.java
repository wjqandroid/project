...
import com.visionvera.live.module.collect.adapter.LiveingAdapter;
 ...
 */
public class LiveingFragment extends BaseFragment implements CollectContract.ICollectList.IView {
    ...
    private void initAdapter() {
        ...
        mAdapter = new LiveingAdapter(act);
    ...
    private void requestLiveList() {
        ...
        map.put(HttpInterface.ParamKeys.PLAY_MODEL, "3");
