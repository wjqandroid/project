...
import com.visionvera.library.widget.banner.loader.ImageLoaderInterface;
import com.visionvera.library.widget.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements ViewPager.OnPageChangeListener {
    public String tag = "banner_layout";
    ...
    private int mLayoutResId = R.layout.banner_layout;
