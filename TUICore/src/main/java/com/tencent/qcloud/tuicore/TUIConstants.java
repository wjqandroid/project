...
public final class TUIConstants {
    ...
    public static final class TUIChat {
        ...
        //订单编号   appNum
        public static final String CHAT_APP_NUM = "appNum";
        public static final String CHAT_ID = "chatId";
        public static final String CHAT_NAME = "chatName";
        public static final String CHAT_TYPE = "chatType";
        //服务结束时间
        public static final String CHAT_END_TIMES = "endTime";
        //用户发起聊天 0|未发起，1|已发起
        public static final String CHAT_CUSTOMER_CALL = "customerCall";
        //用户接听 0|否，1|是
        public static final String CHAT_CUSTOMER_ANSWER = "customerAnswer";
