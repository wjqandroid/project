 ...
 * 注意事项:
 */
data class CommentListResponseBean(
        var dataList: List<Children?>? = null,
        var pageIndex: Int? = null, // 1
        var pageSize: Int? = null, // 10
        var totalPageCnt: Int? = null, // 1
        var totalRecords: Int? = null, // 1
) {
    data class Children(
            var articalId: Int? = null, // 1
            var childrenList: List<Children?>? = null,
            ...
            var parentName: String? = null, // 超级管理员
            var userId: Int? = null, // 1259
            var userName: String? = null, // 新明2
