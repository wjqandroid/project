...
import com.visionvera.psychologist.c.eventbus.CounsellCancelEventBus;
import com.visionvera.psychologist.c.module.counselling.fragment.OrderConsultApplyFragment;
import com.visionvera.psychologist.c.module.counselling.fragment.OrderConsultInviteFragment;
...
public class OrderConsultListActivity extends BaseActivity {
    ...
    private OrderConsultApplyFragment applyFragment;
    private OrderConsultInviteFragment receiveFragment;
    ...
    public static void startActivity(Context context) {
        context.startActivity(new Intent(context, OrderConsultListActivity.class));
    }
    ...
    protected void doYourself() {
        ...
        applyFragment = new OrderConsultApplyFragment();
        receiveFragment = new OrderConsultInviteFragment();
    ...
    public void onEvent(CounsellCancelEventBus event) {
        //预约咨询列表中 受邀列表-待受理-拒绝按钮点击事件
        if (receiveFragment != null) {
            //刷新待受理列表
            receiveFragment.refreshFragment(0);
        }
    }
