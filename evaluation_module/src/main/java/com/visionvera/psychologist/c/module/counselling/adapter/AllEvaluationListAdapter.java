...
/**
 * @Classname:AllEvaluationListAdapter
 * @author:haohuizhao
...
public class AllEvaluationListAdapter extends BaseQuickAdapter<EvaluateListBean.ResultDTO.DataListDTO, BaseViewHolder> {
...
//    public static final String REGEX_MOBILE = "^((13[0-9])|(14[5|7])|(15([0-3]|[5-9]))|(17[013678])|(18[0,5-9]))\\d{8}$";
    ...
    public AllEvaluationListAdapter(Context context, @Nullable List<EvaluateListBean.ResultDTO.DataListDTO> data) {
        super(R.layout.item_all_evaluation, data);
    ...
    protected void convert(@NotNull BaseViewHolder helper, EvaluateListBean.ResultDTO.DataListDTO item) {
        ...
        //评价日期
        tvDate.setText("发布时间："+item.getCreatetime());
    }
}