 ...
 */
public class ConsultantListAdapter extends BaseQuickAdapter<ConsulantListResponseBean.ResultBean, BaseViewHolder> {
    ...
    public ConsultantListAdapter(Context context) {
        super(R.layout.evaluation_module_suggest_item, null);
        this.mContext = context;
    }

    @Override
    protected void convert(BaseViewHolder holder, ConsulantListResponseBean.ResultBean bean) {
