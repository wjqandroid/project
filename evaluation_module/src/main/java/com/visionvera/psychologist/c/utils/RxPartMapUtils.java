...
public class RxPartMapUtils {
    ...
    public static RequestBody toRequestBodyOfStringMap(Map<String, String> value) {
        String json = new Gson().toJson(value);
        RequestBody body = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), json);
        return body;
    }

    public static RequestBody toRequestBodyOfIntegerMap(Map<String, Integer> value) {
        String json = new Gson().toJson(value);
        RequestBody body = RequestBody.create(MediaType.parse("application/json; charset=utf-8"), json);
        return body;
    }
