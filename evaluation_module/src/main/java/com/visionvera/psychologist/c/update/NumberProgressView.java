...
import com.visionvera.live.player.utils.DensityUtil;
...
public class NumberProgressView extends View {
     ...
     * 左侧已完成进度条的颜色
     */
    private int paintLeftColor = getResources().getColor(R.color.viewfinder_laser);
     ...
     * 百分比文字的颜色
     */
    private int paintTextColor = getResources().getColor(R.color.viewfinder_laser);
