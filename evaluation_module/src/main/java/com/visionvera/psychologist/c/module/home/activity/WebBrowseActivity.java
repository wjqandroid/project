...
public class WebBrowseActivity extends BaseActivity {
    ...
    public static void startActivity(Context context, String webUrl, String title){
        context.startActivity(new Intent(context, WebBrowseActivity.class).putExtra("url",webUrl).putExtra("title",title));
    }
...
//                view.loadUrl("javascript:(function() { document.getElementsByTagName('h1')[0].style.display='none'; })()");
        ...
        mAgentWeb = AgentWeb.with(this)
                ...
                .useDefaultIndicator()
                .setWebViewClient((com.just.agentweb.WebViewClient) webViewClient)
                .createAgentWeb()
                .ready()
                .go(webUrl);
